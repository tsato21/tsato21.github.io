...
>
  ...
  <ol class="list-decimal list-inside border border-gray-300 p-4 ms-2">
    ...
    <li>Navigate to Apps Script><code class="text-sm p-1 bg-gray-200 rounded text-gray-800">variables.gs</code> and set each variable.
      <ul class="list-disc list-inside ml-5">
      ...
      <p class="ml-10 text-red-500">* When creating second or subsequent pie charts, copy the variables and change the values of each variable.</p>
    </li>
    ...
    <p class="ml-3 text-red-500">* When creating second or subsequent pie charts, copy the previous function codes and change variable names.</p>
    ...
    <p class="ml-3 text-red-500"> * You can find a sample of the spreadsheet settings from <NuxtLink
